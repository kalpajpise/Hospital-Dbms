				...
				<div class="row" style="text-align: center;">
					<div class="col-6 col-md-4">
							...
							<div class="text list_1_of_2">
								<h3>Patients</h3>
							  	<div class="button"><span><a href="hms/user-login.php">Click Here</a></span>
							  	</div>
					    	</div>
					...
					<div class="col-6 col-md-4">
						...
						<div class="text list_1_of_2">
							<h3>Doctors Login</h3>
							<div class="button"><span><a href="hms/doctor/">Click Here</a></span>
							</div>
						</div>
					</div>
					...
					<div class="col-6 col-md-4">
							...
							<div class="text list_1_of_2">
						  		...
						  		<div class="button"><span><a href="hms/admin/index.php">Click Here</a></span></div>
				    		</div>
